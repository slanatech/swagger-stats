...
module.exports.swsMetrics = {
    ...
    api_all_requests_total: { name: 'api_all_requests_total', type: 'counter', help: 'The total number of all API requests'},
    ...
    api_requests_total: { name: 'api_requests_total', type: 'counter', help: 'The total number of all API requests'}
};
