...
module.exports.supportedOptions = {
    ...
    // Elasticsearch key for SSL connection (https)
    elasticsearchSSLKey      : "elasticsearchSSLKey",

    // Elasticsearch certificat for SSL connection (https)
    elasticsearchSSLCert     : "elasticsearchSSLCert",
