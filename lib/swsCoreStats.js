...
swsCoreStats.prototype.getMetrics = function () {
    ...
    metrics += swsUtil.swsMetricStart(swsUtil.swsMetrics.api_all_requests_total.name);
    metrics += swsUtil.swsMetricValue(swsUtil.swsMetrics.api_all_requests_total.name,this.all.requests);

    metrics += swsUtil.swsMetricStart(swsUtil.swsMetrics.api_all_success_total.name);
    metrics += swsUtil.swsMetricValue(swsUtil.swsMetrics.api_all_success_total.name,this.all.success);

    metrics += swsUtil.swsMetricStart(swsUtil.swsMetrics.api_all_errors_total.name);
    metrics += swsUtil.swsMetricValue(swsUtil.swsMetrics.api_all_errors_total.name,this.all.errors);

    metrics += swsUtil.swsMetricStart(swsUtil.swsMetrics.api_all_client_error_total.name);
    metrics += swsUtil.swsMetricValue(swsUtil.swsMetrics.api_all_client_error_total.name,this.all.client_error);

    metrics += swsUtil.swsMetricStart(swsUtil.swsMetrics.api_all_server_error_total.name);
