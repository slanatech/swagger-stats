...
swsCoreStats.prototype.writeMetrics = function(stream) {
    ...
    stream.write(swsUtil.swsMetricSingleValue(swsUtil.swsMetrics.api_sys_node_memory_rss_bytes.name, this.sys.rss ));
    stream.write(swsUtil.swsMetricSingleValue(swsUtil.swsMetrics.api_sys_node_memory_heapTotal_bytes.name, this.sys.heapTotal ));
    stream.write(swsUtil.swsMetricSingleValue(swsUtil.swsMetrics.api_sys_node_memory_heapUsed_bytes.name, this.sys.heapUsed ));
    stream.write(swsUtil.swsMetricSingleValue(swsUtil.swsMetrics.api_sys_node_memory_external_bytes.name, this.sys.external));
    stream.write(swsUtil.swsMetricSingleValue(swsUtil.swsMetrics.api_sys_node_cpu_usage_percentage.name, this.sys.cpu));
