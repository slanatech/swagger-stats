...
function swsElasticEmitter() {
    ...
    this.elasticsearchSSLCert = null;
    this.elasticsearchSSLKey = null
...
swsElasticEmitter.prototype.initialize = function (swsOptions) {
    ...
    if(swsUtil.supportedOptions.elasticsearchSSLCert in swsOptions) {
        this.elasticsearchSSLCert = swsOptions[swsUtil.supportedOptions.elasticsearchSSLCert]
    }

    if( swsUtil.supportedOptions.elasticsearchSSLKey in swsOptions) {
        this.elasticsearchSSLKey = swsOptions[swsUtil.supportedOptions.elasticsearchSSLKey]
    }
...
swsElasticEmitter.prototype.initTemplate = function(rrr) {
    ...
    var getOptionsVersion = {url:this.elasticURL, json:true, key: this.elasticsearchSSLKey,  cert: this.elasticsearchSSLCert};
    var getOptions = {url:templateURL, json:true, key: this.elasticsearchSSLKey, cert: this.elasticsearchSSLCert};
    let putOptions = {url:templateURL, json:indexTemplate7X, key: this.elasticsearchSSLKey, cert: this.elasticsearchSSLCert};
...
swsElasticEmitter.prototype.flush = function(){
    ...
    var options = {
        ...
        key: this.elasticsearchSSLKey, 
        cert: this.elasticsearchSSLCert
    };
