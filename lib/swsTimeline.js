...
// Count request
swsTimeline.prototype.countRequest = function (req) {
...
swsTimeline.prototype.countResponse = function (res) {
    ...
    this.getTimelineBucket(res.sws ? res.sws.timelineid:req.sws.timelineid).stats.countResponse(
        res.sws ? res.response.status:res.statusCode,
        swsUtil.getStatusCodeClass(res.sws ? res.response.status : res.statusCode),
