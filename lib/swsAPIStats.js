...
swsAPIStats.prototype.getApiOpDetails = function(path,method) {
    ...
    if(!(method in this.apidetails[path]) ) this.apidetails[path][method] = {
        duration: new swsHistogram([1,10,100]),     // Request duration histogram
        req_size: new swsHistogram([1,10,100]),     // Request size histogram
        res_size: new swsHistogram([1,10,100])      // Response size histogram
    };
