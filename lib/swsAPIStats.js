...
function swsAPIStats() {
    ...
    // rest of Prometheus metrics are initialized in initialize()
}
...
swsAPIStats.prototype.initialize = function(swsOptions) {
    ...
    if(!this.promClientMetrics.api_request_total || 'durationBuckets' in swsOptions) {
    ...
    if(!this.promClientMetrics.api_request_duration_milliseconds || 'requestSizeBuckets' in swsOptions) {
    ...
    if(!this.promClientMetrics.api_request_duration_milliseconds || 'responseSizeBuckets' in swsOptions) {
