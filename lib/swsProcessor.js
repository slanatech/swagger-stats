...
// Initialize
swsProcessor.prototype.init = function () {
...
swsProcessor.prototype.processOptions = function () {
...
swsProcessor.prototype.getStats = function ( query ) {
    ...
    // sys and core statistics are returned always
    let result = this.coreStats.getStats();
